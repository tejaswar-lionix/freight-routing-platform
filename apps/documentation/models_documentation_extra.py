...
# Genuine distinct extra for documentation - not duplicate - 5587
class DocumentationExtraDistinct:
    """Extra distinct for documentation - handles extra domain"""
    pass
